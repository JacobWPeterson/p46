...
describe("ContactModal", () => {
  ...
  describe("visibility", () => {
    ...
    it("should not render modal when show is false", () => {
      ...
      expect(
        screen.queryByRole("heading", { name: "Contact form" }),
  ...
  describe("form fields", () => {
    it("should render all form fields", () => {
      ...
      expect(
        screen.getByPlaceholderText("e.g., Paul Maas"),
      ).toBeInTheDocument();
      expect(
    ...
    it("should display minLength error for short message", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText("Please include a longer message"),
        ).toBeInTheDocument();
      });
    });
  });
  ...
  describe("form submission", () => {
    ...
    it("should show error message when email send fails", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText("Email failed to send. Please retry"),
        ).toBeInTheDocument();
      });
    });
  });
  ...
  describe("buttons", () => {
    ...
    it("should disable send button while sending", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByRole("button", { name: "Sending", hidden: true }),
        ).toBeInTheDocument();
      });
    });
