...
describe("Mirador", () => {
  ...
  it("should accept manifest and canvasIndex props", () => {
    ...
    const { rerender } = render(
      <Mirador manifest={manifest} canvasIndex={canvasIndex} />,
    );
    ...
    rerender(
      <Mirador manifest="https://example.com/manifest2" canvasIndex={0} />,
    );
    expect(rerender).toBeDefined();
  });
  ...
  it("should handle prop changes", () => {
    ...
    rerender(
      <Mirador manifest="https://example.com/manifest2" canvasIndex={1} />,
    );
