      ...
      <table>
        <tbody>
          ...
          <tr className={styles.Row}>
            ...
            <td>
              The letter is partially identifiable (see discussion above).
            </td>
          </tr>
          <tr className={styles.Row}>
            <td className={styles.SymbolCell}>[α̣]</td>
            <td>
              ...
              reconstructed transcription, these are moved inside brackets and
              the expected letter is provided with an underdot to distinguish it
              from a fully lacunose portion of the page (see discussion above).
            </td>
          </tr>
          <tr className={styles.Row}>
            <td className={styles.SymbolCell}>¦</td>
          ...
          <tr className={styles.Row}>
            ...
            <td>
              the identifiable hands of the manuscript, with M1 being the
          ...
          <tr className={styles.Row}>
            ...
            <td>
              (=ut videtur) The reading or letter(s) in question are not
              certain.
            </td>
          </tr>
        </tbody>
