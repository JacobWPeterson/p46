...
export const Guide = (): ReactElement => (
  <div className={styles.Container} id="guide">
    ...
    <p className={styles.GuideText}>
      The following is a new transcription of 𝔓46 created for this thesis based
      on the images produced by the Center for the Study of New Testament
      Manuscripts and personal visits to the Chester Beatty Library. There are a
      few different features needing explanation to facilitate ease of use. The
      reading marks and few rough breathing marks have not been replicated.
      Since the transcription contains a reconstruction of lacunose and damaged
      texts, characters that would be a blank space with an underdot in a
      diplomatic edition have been moved to inside the square brackets, where
      the letter is presented with an underdot. This allows for distinguishing
      between a character that is able to be partially identified but has an
      underdot and a blank space with an underdot. Below each transcribed page
      is a list of corrections, if applicable. The number before the correction
      refers to the line, not the scripture reference. Any in scribendo
      corrections have been recorded here, with the main text of the
      transcription reading the corrected text. If the original scribe made what
      appears to be a subsequent correction, the uncorrected text is in the main
      text block. The correction list and hand ascriptions are based upon my
      article “An Updated Correction List for Chester Beatty BP II + P.Mich.
    ...
    <table>
      <tbody>
        ...
        <tr className={styles.Row}>
          <td className={styles.SymbolCell}>[α̣]</td>
          <td>
            Traces of ink remain, but no letter is identifiable. For the
            reconstructed transcription, these are moved inside brackets and the
            expected letter is provided with an underdot to distinguish it from
            a fully lacunose portion of the page (see discussion above).
          </td>
        </tr>
        <tr className={styles.Row}>
          <td className={styles.SymbolCell}>¦</td>
        ...
        <tr className={styles.Row}>
          ...
          <td>
            the identifiable hands of the manuscript, with M1 being the original
            scribe and all others being correctors
          </td>
        </tr>
        <tr className={styles.Row}>
          <td className={styles.SymbolCell}>
        ...
        <tr className={styles.Row}>
          ...
          <td>
            (=ut videtur) The reading or letter(s) in question are not certain.
          </td>
        </tr>
      </tbody>
    </table>
    ...
    <p className={styles.GuideText}>
      ...
      formations. If you navigate away from the target image, a message will pop
      up to remind you which image the lesson covers so you can navigate back.
    </p>
    <p className={styles.GuideText}>
    ...
    <p className={styles.GuideText}>
      ...
      historical owners, location, scripts, and find a bibliography of resources
